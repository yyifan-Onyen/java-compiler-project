...
public class Identification implements Visitor<Object, Object> {
    ...
    //constructor we have on class ppt --zhou
  ...
  //ppt ways to implement this method but failed to implement--zhou 
	...
	table.enter(cd.name,cd);
	 for (FieldDecl fieldDecl : cd.fieldDeclList) {
         table.classFields.get(cd.name).put(fieldDecl.name, fieldDecl);
     }

     for (MethodDecl methodDecl : cd.methodDeclList) {
         table.classFields.get(cd.name).put(methodDecl.name, methodDecl);
         table.classMethods.get(cd.name).put(methodDecl.name, methodDecl);
     }
	}
	//then visit classes
	for(ClassDecl cd: prog.classDeclList) {
    ...
    public Object visitPackage(Package prog, Object arg) {
        ...
        for (ClassDecl classDecl : prog.classDeclList) {            
        	if (table.retrieveClass(classDecl.name) != null) {
        		reporter.reportError("*** line " + classDecl.posn.lineNumber + ": class has already been declared " + classDecl.name + ".");
        	}
...
//modified--zhou
	...
	*/
    ...
    public Object visitVardeclStmt(VarDeclStmt stmt, Object arg) {
    	this.badname = stmt.varDecl.name;
...
*/
    ...
    public Object visitIdRef(IdRef ref, Object arg) {
    	if (ref.id.spelling.equals(this.badname)) {
			reporter.reportError(
    ...
    public Object visitQRef(QualRef ref, Object arg) {  
        ...
        if (ref.ref.decl.type instanceof ClassType) {
            ...
            table.classNameContext = className;
        }
